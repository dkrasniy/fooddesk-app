    ...
    <div className="bg-green-600  w-full p-4 pb-40">
      <div className="flex justify-between items-center max-w-6xl mx-auto">
        ...
        <div>
          ...
          ><span   className="text-white font-semibold flex items-center">{auth.name} <ChevronDown/></span>
          
          
          <div className={`w-64 bg-white rounded-lg p-6 shadow-xl absolute right-0 top-auto ${dropDownOpen ? 'block':'hidden'}`}> 
